...
class Perfil(object):
	...
	def __init__(self, nome, telefone, empresa): #init é construtura de perfis
		if(len(nome) < 3):
			raise ArgumentoInvalidoError('Nome deve ter pelo menos 3 caracteres')
		self.nome = nome #atributo de instancia (parte da forma, mas varia pra cada "objeto")
...
class Perfil_Vip(Perfil):
	'Classe padrão para perfis de usuarios VIPs'
